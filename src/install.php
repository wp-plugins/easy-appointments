...
class EAInstallTools
{
	...
	public function init_db()
	{
		...
		// whole table struct
		$table_querys[] = <<<EOT
CREATE TABLE IF NOT EXISTS `{$table_prefix}ea_appointments` (
...
$table_querys[] = <<<EOT
CREATE TABLE IF NOT EXISTS `{$table_prefix}ea_connections` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
$table_querys[] = <<<EOT
CREATE TABLE IF NOT EXISTS `{$table_prefix}ea_locations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
$table_querys[] = <<<EOT
CREATE TABLE IF NOT EXISTS `{$table_prefix}ea_staff` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
$table_querys[] = <<<EOT
CREATE TABLE IF NOT EXISTS `{$table_prefix}ea_services` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
